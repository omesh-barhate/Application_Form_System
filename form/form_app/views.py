...
def sy_bms_market_form_save(request):
    if request.method!="POST":
        ...
        try:
            ...
            ssc=FY_SEM1_marksheet.objects.create(university_name=board_name,school_name=school_name,medium=medium,seat_number=seat_number,marksheet_number=marksheet_number,passing_year=passing_month,cgpa=gpa,passing_attempts=passing_attempts,marks_obtained=marks_obtained,marks_out_of=marks_outof,account_id=user,academic_id=session)
            ssc.save()
            idss=ssc.id

            hsc=FY_SEM2_marksheet.objects.create(university_name=board_name_hsc,school_name=school_name_hsc,medium=medium_hsc,seat_number=seat_number_hsc,marksheet_number=marksheet_number_hsc,passing_year=passing_month_hsc,cgpa=gpa_hsc,passing_attempts=passing_attempts_hsc,marks_obtained=marks_obtained_hsc,marks_out_of=marks_outof_hsc,account_id=user,academic_id=session)
            hsc.save()
            idh=hsc.id
...
def ty_bammc_advert_form_save(request):
    if request.method!="POST":
        ...
        try:
            ...
            ssc=SY_SEM1_marksheet.objects.create(university_name=board_name,school_name=school_name,medium=medium,seat_number=seat_number,marksheet_number=marksheet_number,passing_year=passing_month,cgpa=gpa,passing_attempts=passing_attempts,marks_obtained=marks_obtained,marks_out_of=marks_outof,account_id=user,academic_id=session)
            ssc.save()
            idss=ssc.id

            hsc=SY_SEM2_marksheet.objects.create(university_name=board_name_hsc,school_name=school_name_hsc,medium=medium_hsc,seat_number=seat_number_hsc,marksheet_number=marksheet_number_hsc,passing_year=passing_month_hsc,cgpa=gpa_hsc,passing_attempts=passing_attempts_hsc,marks_obtained=marks_obtained_hsc,marks_out_of=marks_outof_hsc,account_id=user,academic_id=session)
            hsc.save()
            idh=hsc.id
